...
public partial struct TimeStamp
{
  ...
  /// <summary>
  /// Creates a timestamp the given number of microseconds after midnight, 1 January 1970 UTC.
  /// </summary>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static TimeStamp FromUnixMicroseconds(long unixMicroseconds)
    => UnixEpoch.AddMicroseconds(unixMicroseconds);
  ...
  /// </summary>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public static TimeStamp FromUnixMicroseconds(long unixMicroseconds, TimeZoneInfo timeZone)
  {
    var ticksTimeZone = Ticks.FromUnixMicroseconds(unixMicroseconds);
    return new TimeStamp(ticksTimeZone, timeZone);
  }
  ...
  /// <summary>
  /// Gets the number of microseconds since Midnight, 1 January 1970, UTC.
  /// </summary>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public long ToUnixMicroseconds()
    => TicksUtc.ToUnixMicroseconds();

  /// <summary>
  /// Gets the number of microseconds since Midnight, 1 January 1970, in the given <paramref name="timeZone"/>
  /// Compute intensive. Do not use in a hot path.
  /// </summary>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public long ToUnixMicroseconds(TimeZoneInfo timeZone)
    => AsTicks(timeZone).ToUnixMicroseconds();
}
