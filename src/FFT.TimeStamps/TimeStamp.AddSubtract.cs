...
public partial struct TimeStamp
{
  ...
  /// <summary>
  /// Returns a <see cref="TimeStamp"/> advanced by the given number of <paramref name="microseconds"/>.
  /// </summary>
  /// <param name="microseconds">The number of microseconds of ABSOLUTE time to advance the <see cref="TimeStamp"/>.</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public TimeStamp AddMicroseconds(double microseconds)
    => new TimeStamp(TicksUtc.AddMicroseconds(microseconds));

  /// <summary>
  /// Returns a <see cref="TimeStamp"/> advanced by the given number of <paramref name="microseconds"/> in the given <paramref name="timeZone"/>.
  /// Compute intensive. Don't use in a hot path.
  /// </summary>
  /// <param name="microseconds">The number of microseconds of TIMEZONE time to advance the <see cref="TimeStamp"/>.</param>
  /// <param name="timeZone">The timezone of the clock being adjusted.</param>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public TimeStamp AddMicroseconds(double microseconds, TimeZoneInfo timeZone)
    => new TimeStamp(AsTicks(timeZone).AddMicroseconds(microseconds), timeZone);
